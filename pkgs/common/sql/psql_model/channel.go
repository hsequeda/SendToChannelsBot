...
func (q channelQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Channel, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psql_model: failed to execute a one query for channel")
	}
...
func (q channelQuery) All(ctx context.Context, exec boil.ContextExecutor) (ChannelSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "psql_model: failed to assign all query results to Channel slice")
	}
...
func (q channelQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: failed to count channel rows")
	}
...
func (q channelQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "psql_model: failed to check if channel exists")
	}
...
func FindChannel(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Channel, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psql_model: unable to select from channel")
	}
...
func (o *Channel) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("psql_model: no channel provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "psql_model: unable to insert into channel")
	}
...
func (o *Channel) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("psql_model: unable to update channel, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to update channel row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: failed to get rows affected by update for channel")
	}
...
func (q channelQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to update all for channel")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to retrieve rows affected for channel")
	}
...
func (o ChannelSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to update all in channel slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to retrieve rows affected all in update all channel")
	}
	return rowsAff, nil
}
...
func (o *Channel) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("psql_model: no channel provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("psql_model: unable to upsert channel, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "psql_model: unable to upsert channel")
	}
...
func (o *Channel) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("psql_model: no Channel provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to delete from channel")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: failed to get rows affected by delete for channel")
	}
...
func (q channelQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("psql_model: no channelQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to delete all from channel")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: failed to get rows affected by deleteall for channel")
	}
...
func (o ChannelSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to delete all from channel slice")
	}
...
func (o *Channel) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("psql_model: no Channel provided for reload")
	}
...
func (o *ChannelSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("psql_model: empty ChannelSlice provided for reload all")
	}
...
func (o *ChannelSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "psql_model: unable to reload all in ChannelSlice")
	}
...
func ChannelExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "psql_model: unable to check if channel exists")
	}
