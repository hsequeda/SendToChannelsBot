...
func (q messageQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Message, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psql_model: failed to execute a one query for message")
	}
...
func (q messageQuery) All(ctx context.Context, exec boil.ContextExecutor) (MessageSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "psql_model: failed to assign all query results to Message slice")
	}
...
func (q messageQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: failed to count message rows")
	}
...
func (q messageQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "psql_model: failed to check if message exists")
	}
...
func FindMessage(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Message, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psql_model: unable to select from message")
	}
...
func (o *Message) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("psql_model: no message provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "psql_model: unable to insert into message")
	}
...
func (o *Message) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("psql_model: unable to update message, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to update message row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: failed to get rows affected by update for message")
	}
...
func (q messageQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to update all for message")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to retrieve rows affected for message")
	}
...
func (o MessageSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to update all in message slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to retrieve rows affected all in update all message")
	}
	return rowsAff, nil
}
...
func (o *Message) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("psql_model: no message provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("psql_model: unable to upsert message, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "psql_model: unable to upsert message")
	}
...
func (o *Message) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("psql_model: no Message provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to delete from message")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: failed to get rows affected by delete for message")
	}
...
func (q messageQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("psql_model: no messageQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to delete all from message")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: failed to get rows affected by deleteall for message")
	}
...
func (o MessageSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psql_model: unable to delete all from message slice")
	}
...
func (o *Message) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("psql_model: no Message provided for reload")
	}
...
func (o *MessageSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("psql_model: empty MessageSlice provided for reload all")
	}
...
func (o *MessageSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "psql_model: unable to reload all in MessageSlice")
	}
...
func MessageExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "psql_model: unable to check if message exists")
	}
